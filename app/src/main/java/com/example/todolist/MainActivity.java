    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View viewInput = inflater.inflate(R.layout.note_imput, null, false);

                final EditText editTitle = viewInput.findViewById(R.id.edt_title);
                final EditText editDescription = viewInput.findViewById(R.id.edt_description);
